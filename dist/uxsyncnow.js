...
var options = new Options_1.Options("./", configType);
var api = UXsyncNowREST_1.UXsyncNowREST.getUXsyncNowREST();
var applications = NowApplications_1.NowApplications.getNowApplications();
...
api.init()
    .then(function () {
    var apps = options.get('applications', {});
    var tables = options.get('tables', {});
    var multifile = options.get('multifile', 'record');
    var app = null;
    var appWatcher;
    ...
    function initSetup(cb) {
        ...
        var interval = options.get('interval', 30000);
